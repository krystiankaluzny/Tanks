...
void Battle::loadLevel(std::string path)
{
...
void Battle::checkCollisionTankWithLevel(Tank* tank, Uint32 dt)
{
...
void Battle::checkCollisionTwoTanks(Tank* tank1, Tank* tank2, Uint32 dt)
{
...
void Battle::checkCollisionBulletWithLevel(Bullet* bullet)
{
...
void Battle::checkCollisionBulletWithBush(Bullet *bullet)
{
    if(bullet == nullptr) return;
    if(bullet->collide) return;
...
void Battle::checkCollisionPlayerBulletsWithEnemy(Player *player, Enemy *enemy)
{
...
void Battle::checkCollisionEnemyBulletsWithPlayer(Enemy *enemy, Player *player)
{
...
void Battle::checkCollisionTwoBullets(Bullet *bullet1, Bullet *bullet2)
{
...
void Battle::checkCollisionPlayerWithBonus(Player *player, Bonus *bonus)
{
