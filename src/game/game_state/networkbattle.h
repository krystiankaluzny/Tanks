#ifndef NETWORKNetworkBattle_H
#define NETWORKNetworkBattle_H
 ...
 */
class NetworkBattle : public GameState, Object
{
public:
    /**
     * Domyślny konstruktor - umożliwia grę dla jednego gracza
     */
    NetworkBattle(Game* parent);
    /**
     ...
     */
    NetworkBattle(Game* parent, int players_count);
    /**
     ...
     */
    NetworkBattle(Game* parent, std::vector<Player*> players, int previous_level);
...
private:
     ...
     * @see NetworkBattle::loadLevel(std::string path)
     */
    void nextLevel();
    /**
