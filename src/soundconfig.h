...
namespace SoundConfig
{
    ...
    const Sound BULLET_HIT_MAP_BOUNDRIES{"sounds/bullet_hit_map_bounderies.wav", 100.0, 1.0, true};
    ...
    // const Sound HIGHSCORE_BEATED {"sounds/highscore_beated.wav", 100.0, true};
