...
unsigned AppConfig::tank_shield_time = 7000; //czas trwania osłonki
unsigned AppConfig::tank_frozen_time = 5000; //czas zatrzymania czołgów
unsigned AppConfig::tank_boat_time = 12000; //czas możliwości jazdy po wodzie
