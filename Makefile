...
LFLAGS = -mwindows -O
LIBS = -LSDL/i686-w64-mingw32/lib -lmingw32 -lSDL2main -lSDL2 -lSDL2_image -lSDL2_ttf -L$(BIN) -l$(STATIC_LIB_NAME)
PROJECT_NAME = Tanks
...
TARGET = Tanks
TEMPLATE = app
POBJS = src_main.o src_app.o src_app_state_game.o src_appconfig.o src_app_state_menu.o src_app_state_scores.o    src_engine_engine.o src_engine_renderer.o src_engine_spriteconfig.o src_objects_player.o
...
all: $(POBJS) $(LSOBJS)
	...
	$(CC) $(POBJS) $(INCLUDEPATH) $(LIBSPATH) $(LIBS) $(LFLAGS) -o $(BIN)/$(PROJECT_NAME)
