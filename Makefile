...
HEADERS = src/app.h src/appconfig.h  src/appthread.h  src/type.h  src/game/game.h  src/game/engine/engine.h  src/game/engine/renderer.h  src/game/engine/spriteconfig.h  src/game/game_state/battle.h  src/game/game_state/gamestate.h  src/game/game_state/menu.h  src/game/game_state/scores.h  src/game/game_state/server.h  src/game/objects/bonus.h  src/game/objects/brick.h  src/game/objects/bullet.h  src/game/objects/eagle.h  src/game/objects/enemy.h  src/game/objects/object.h  src/game/objects/player.h  src/game/objects/tank.h  src/network/servertcp.h  src/event/event.h  src/event/eventstore.h  src/network/network.h  src/network/tcpconnection.h  src/network/clienttcp.h  src/game/game_state/client.h  src/game/handler/handler.h  src/game/game_state/networkbattle.h  src/util/myqueue.h  src/util/shareddata.h  src/game/graphicthread.h
...
PROJECT_NAME = Tanks
SOURCES = src/app.cpp src/appconfig.cpp  src/main.cpp  src/game/game.cpp  src/game/engine/engine.cpp  src/game/engine/renderer.cpp  src/game/engine/spriteconfig.cpp  src/game/game_state/battle.cpp  src/game/game_state/menu.cpp  src/game/game_state/scores.cpp  src/game/game_state/server.cpp  src/game/objects/bonus.cpp  src/game/objects/brick.cpp  src/game/objects/bullet.cpp  src/game/objects/eagle.cpp  src/game/objects/enemy.cpp  src/game/objects/object.cpp  src/game/objects/player.cpp  src/game/objects/tank.cpp  src/network/servertcp.cpp  src/event/event.cpp  src/event/eventstore.cpp  src/network/network.cpp  src/appthread.cpp  src/network/clienttcp.cpp  src/network/tcpconnection.cpp  src/game/game_state/client.cpp  src/game/handler/handler.cpp  src/game/game_state/networkbattle.cpp  src/util/myqueue.cpp  src/util/shareddata.cpp  src/game/graphicthread.cpp
SRC = src
TARGET = Tanks
TEMPLATE = app
OBJS = src_app.o src_appconfig.o src_main.o src_game_game.o src_game_engine_engine.o src_game_engine_renderer.o src_game_engine_spriteconfig.o src_game_game_state_battle.o src_game_game_state_menu.o src_game_game_state_scores.o src_game_game_state_server.o src_game_objects_bonus.o src_game_objects_brick.o src_game_objects_bullet.o src_game_objects_eagle.o src_game_objects_enemy.o src_game_objects_object.o src_game_objects_player.o src_game_objects_tank.o src_network_servertcp.o src_event_event.o src_event_eventstore.o src_network_network.o src_appthread.o src_network_clienttcp.o src_network_tcpconnection.o src_game_game_state_client.o src_game_handler_handler.o src_game_game_state_networkbattle.o src_util_myqueue.o src_util_shareddata.o src_game_graphicthread.o
...
src_util_myqueue.o: src/util/myqueue.cpp
	$(CC) $(CFLAGS) $(INCLUDEPATH) src/util/myqueue.cpp -o src_util_myqueue.o

src_util_shareddata.o: src/util/shareddata.cpp
	$(CC) $(CFLAGS) $(INCLUDEPATH) src/util/shareddata.cpp -o src_util_shareddata.o

src_game_graphicthread.o: src/game/graphicthread.cpp
	$(CC) $(CFLAGS) $(INCLUDEPATH) src/game/graphicthread.cpp -o src_game_graphicthread.o
