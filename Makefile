...
HEADERS = src/app.h src/appconfig.h  src/appthread.h  src/type.h  src/game/game.h  src/game/engine/engine.h  src/game/engine/renderer.h  src/game/engine/spriteconfig.h  src/game/game_state/battle.h  src/game/game_state/gamestate.h  src/game/game_state/menu.h  src/game/game_state/scores.h  src/game/game_state/server.h  src/game/objects/bonus.h  src/game/objects/brick.h  src/game/objects/bullet.h  src/game/objects/eagle.h  src/game/objects/enemy.h  src/game/objects/object.h  src/game/objects/player.h  src/game/objects/tank.h  src/network/servertcp.h  src/event/event.h  src/scopelock.h  src/event/eventstore.h  src/shareddata.h  src/network/network.h  src/network/clenttcp.h  src/network/tcpconnection.h
...
src_network_clenttcp.o: src/network/clenttcp.cpp
	$(CC) $(CFLAGS) $(INCLUDEPATH) src/network/clenttcp.cpp -o src_network_clenttcp.o
